...
final_output = get_linear_layer(last_run_output)

softmax = tf.nn.softmax_cross_entropy_with_logits(labels=y, logits=final_output)
...
print("Testing Accuracy: ", sess.run(accuracy, feed_dict={_inputs:batch_x, y:batch_y}))
